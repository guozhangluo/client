...
export default class FtMLotManagerRequest {
    ...
    static sendMobileFTIssueRequest = (object) => {
        let requestBody = FtMLotManagerRequestBody.buildMobileFTIssue(object.erpTime, object.materialLotUnitList, object.issueWithDoc);
        let requestHeader = new FtMLotManagerRequestHeader();
        let request = new Request(requestHeader, requestBody, UrlConstant.GCftMaterialLotManagerUrl);
        let requestObject = {
            request: request,
