...
export default class WeightManagerRequestBody {
    ...
    static buildWeight(materialLots) {
        ...
        materialLots.forEach(materialLot => {
            let weightModel = new WeightModel(materialLot.materialLotId, materialLot.parentMaterialLotId, materialLot.weight, materialLot.boxsWeightFlag, materialLot.scanSeq, materialLot.boxsScanSeq);
