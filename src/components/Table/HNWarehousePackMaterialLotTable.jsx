 ...
 * 包装物料批次
 */
export default class HNWarehousePackMaterialLotTable extends EntityScanViewTable {

    static displayName = 'HNWarehousePackMaterialLotTable';
