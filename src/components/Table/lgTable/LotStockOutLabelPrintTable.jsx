...
export default class LotStockOutLabelPrintTable extends EntityScanViewTable {

    static displayName = 'LotStockOutLabelPrintTable';
    ...
    print = () => {
        ...
        let requestObject = {
          ...
          MaterialLotRequest.sendBoxLabelPrintRequest(requestObject);
    }
