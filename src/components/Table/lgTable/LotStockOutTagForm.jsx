...
import LotStockOutTagShowTable from './LotStockOutTagShowTable';

export default class LotStockOutTagForm extends EntityForm {

    static displayName = 'LotStockOutTagForm';
    ...
    buildForm = () => {
        return (<LotStockOutTagShowTable ref={(materialLotTable) => { this.materialLotTable = materialLotTable }} rowKey={DefaultRowKey} 
