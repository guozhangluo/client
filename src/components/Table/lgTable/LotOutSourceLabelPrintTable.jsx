...
export default class LotOutSourceLabelPrintTable extends EntityScanViewTable {

    static displayName = 'LotOutSourceLabelPrintTable';
    ...
    print = () => {
        ...
        let requestObject = {
          ...
          MaterialLotRequest.sendLotOutSourceLabelPrintRequest(requestObject);
    }
