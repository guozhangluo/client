...
export default class OtherShipReservedOrderTable extends EntityListTable {

    static displayName = 'OtherShipReservedOrderTable';
    ...
    selectRow = (record) => {
        ...
        ReservedManagerRequest.sendGetOtherShipReservedMLot(object);
    }
