 ...
 * RW箱标签打印
 */
export default class GCRwStockOutTagging2Table extends EntityScanViewTable {

    static displayName = 'GCRwStockOutTagging2Table';
    ...
    handlePrint = () => {
        ...
        if (data && data.length > 0) {
            ...
            RwMLotManagerRequest.sendRWStockOutPrintRequest(requestObject);
        }
    }
