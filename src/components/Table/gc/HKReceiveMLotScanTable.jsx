...
export default class HKReceiveMLotScanTable extends EntityScanViewTable {

    static displayName = 'HKReceiveMLotScanTable';
    ...
    createReceive = () => {
        return <Button key="receive" type="primary" style={styles.tableButton} loading={this.state.loading} icon="plus" onClick={this.hkWarehouseReceive}>
