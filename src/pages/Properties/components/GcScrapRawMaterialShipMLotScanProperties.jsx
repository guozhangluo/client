...
import ScrapRawMaterialShipMLotScanTable from "../../../components/Table/gc/ScrapRawMaterialShipMLotScanTable";
import GcScrapRawMaterialWaitShipMLotProperties from "./GcScrapRawMaterialWaitShipMLotProperties";

export default class GcScrapRawMaterialShipMLotScanProperties extends EntityScanProperties{

    static displayName = 'GcScrapRawMaterialShipMLotScanProperties';
    ...
    buildTable = () => {
        return <ScrapRawMaterialShipMLotScanTable orderTable={this.props.orderTable} pagination={false} 
    ...
    buildOtherComponent = () => {
      return <GcScrapRawMaterialWaitShipMLotProperties
                     ref={(waitShipMLotProperties) => { this.waitShipMLotProperties = waitShipMLotProperties }} 
                     tableRrn={this.props.waitShipTableRrn} />
  }
}