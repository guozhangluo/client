...
import HKReceiveMLotScanTable from "../../../components/Table/gc/HKReceiveMLotScanTable";
import HKWaitReceiveMLotProperties from "./HKWaitReceiveMLotProperties";

export default class HKWarehouseReceiveProperties extends EntityScanProperties{

    static displayName = 'HKWarehouseReceiveProperties';
