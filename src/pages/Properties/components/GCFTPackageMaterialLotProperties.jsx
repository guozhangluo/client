...
import GCFTPackMaterialLotTable from "../../../components/Table/GCFTPackMaterialLotTable";

const PackageType = "FTPackCase";

export default class GCFTPackageMaterialLotProperties extends EntityScanProperties{
    ...
    buildTable = () => {
        return <GCFTPackMaterialLotTable pagination={false} 
