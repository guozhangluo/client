...
import HNWarehouseWltOtherStockOutMLotScanTable from "../../../components/Table/gc/HNWarehouseWltOtherStockOutMLotScanTable";

export default class HNWarehouseWltOtherStockOutMLotScanProperties extends EntityScanProperties{

    static displayName = 'HNWarehouseWltOtherStockOutMLotScanProperties';
  ...
  validationWltMLot = (materialLots, materialLot) => {
    ...
    buildTable = () => {
        return <HNWarehouseWltOtherStockOutMLotScanTable
