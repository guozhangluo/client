...
import GcHNSampleCollectionStockOutMLotScanTable from "../../../components/Table/gc/GcHNSampleCollectionStockOutMLotScanTable";

export default class GcHNSampleCollectionStockOutMLotScanProperties extends EntityScanProperties{

    static displayName = 'GcHNSampleCollectionStockOutMLotScanProperties';
  ...
  validationWltMLot = (materialLots, materialLot) => {
    ...
    buildTable = () => {
        return <GcHNSampleCollectionStockOutMLotScanTable 
