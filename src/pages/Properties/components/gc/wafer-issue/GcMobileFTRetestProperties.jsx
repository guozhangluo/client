...
export default class GcMobileFTRetestProperties extends MobileProperties{

    static displayName = 'GcMobileFTRetestProperties';
    ...
    handleSubmit = () => {
      ...
      RetestManagerRequest.sendMobileFtRetestRequest(requestObject);
    }
